...
import com.charlesdrews.dragandswipe.presenters.MyItemTouchHelperCallback;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        // Use the new ItemTouchHelperCallback class to create an ItemTouchHelper,
        // then attach it to the recycler view.
